...
en Publish blijven de expliciete persistence boundary. V1 heeft geen ESS- of
managergoedkeuring.
...
De eerste UI-surface is HR Admin: medewerkeruren, Actual Work-instellingen,
teamoverzicht en Insights. Employee- en managerrechten worden niet impliciet
uitgebreid. Cross-employee, cross-group, cross-tenant en manager-zonder
HR-recht moeten negatief blijven.
...
3. Authenticated HR Admin browserflow met persistence readback, correctie,
   gesloten periode, Jan voor/na de roosterwissel en Leave/kalender/Insights.
