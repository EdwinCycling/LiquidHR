...
- Het voormalige Dashboard Widget-beheer is retired; de settings-hub bevat geen widgetcatalogus of rol-widgetmatrix meer. Zie [`LIQUID_ANALYSE_AN0_AN1.md`](../reports/LIQUID_ANALYSE_AN0_AN1.md) voor het Analyse-contract.
