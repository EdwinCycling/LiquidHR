...
> **Aanvulling 2026-08-10 - aanmaakregels en wizard-UX.** Het dienstverbandnummer is een niet-negatief numeriek volgnummer per medewerker: de wizard neemt het hoogste eerder gebruikte numerieke nummer van die medewerker en verhoogt dit met één. Het nummer hoeft niet uniek te zijn over medewerkers, administraties of andere dienstverbanden heen. Het IKV-nummer is eveneens alleen per medewerker uniek; verschillende medewerkers mogen hetzelfde IKV-nummer hebben. De wizard ondersteunt ook een tijdelijk contract zonder einddatum. De proeftijd wordt server-side en database-side gevalideerd: maximaal zes maanden betekent geen proeftijd, langer dan zes maanden en korter dan twee jaar maximaal één maand (een expliciet ingerichte CAO-afwijking mag maximaal twee maanden toestaan), twee jaar of langer en onbepaalde tijd maximaal twee maanden, en tijdelijk zonder einddatum maximaal één maand. Zie voor de wettelijke hoofdregel [Rijksoverheid: Hoelang duurt mijn proeftijd?](https://www.rijksoverheid.nl/vraag-en-antwoord/arbeidsovereenkomst-en-cao/hoelang-duurt-een-proeftijd).

> De aanmaakwizard toont na **Overige** eerst **Controleren** en schrijft pas na **Dienstverband aanmaken**. Annuleren is op iedere stap beschikbaar. De administratiekeuze kan over de volle breedte actieve/gearchiveerde medewerkers en beschikbare CAO's tonen. Einddatums hebben snelkeuzes van één, drie, zes en twaalf maanden. Decimale invoer accepteert zowel de Nederlandse komma als de punt; een toekomstige persoonlijke locale-instelling blijft een gebruikersvoorkeur en geen systeemwijde aanname.
