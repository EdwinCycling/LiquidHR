...
de Employee Wizard- en contracttijdlijncontrole. Er is geen Leave Engine gebouwd
of gewijzigd. Production, Payroll en de TEST-BOUNDARY zijn buiten scope.
...
Alle drie employees zijn `CONFIRMED`, primair en niet gearchiveerd. Per fixture
...
- Schedule: `cad2e59e-a608-4b27-a399-7c0f730c1106`, 32/40 uur, factor 0,80
...
Deze records zijn geschikt als stabiele toekomstige input voor Leave Engine
acceptance: employee → employment → contract, administratie/HR-groep,
organisatieplaatsing, werkdagen/uren/factor, salary history en inkomensrelatie
zijn via dezelfde tenant- en HR-groepsscope gekoppeld. De contractreeks gebruikt
de bestaande effective-dated regels; de contractdatumcorrectie is als
transactionele UI/domain-mutatie vastgelegd met change-set/auditkoppeling.

Acceptance-invarianten:

- HR Admin ziet en laadt Jan, Piet en Frank via de echte UI; browser reload blijft correct.
- Manager en Employee krijgen geen contractactie of succesvolle contractmutatie buiten hun scope.
