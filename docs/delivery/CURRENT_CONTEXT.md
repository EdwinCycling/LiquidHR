...
## LiquidHR Journeys — bouwstap 1 en 2 afgerond 2026-08-12
...
- Stap 1 bevat HR-configuratie; stap 2 bevat de gepinde runtime, preview/activatie, concrete participants, HR Live-lijst/detail, lifecycle, replacementhistorie en bestaande reminderadapter. Stap 3 (self/preboarding/participantprojecties, outcomes en widgets) ontbreekt bewust.
- Gekoppelde Supabase-testomgeving: `wnpfloqpjvaacobppbpk`. Geregistreerd zijn `20260812081325`, `20260812100445`, `20260812122500`, `20260812141000`, `20260812143000` en `20260812143500`. Remote pgTAP is 18/18 plus 12/12 groen. Runtime-RLS/grants/wrappers en tenant-/HR-groepisolatie zijn groen; advisors hebben geen actionable Journey-security- of performancebevinding. Officiële types zijn gegenereerd.
- Lokale verificatie: 164 testbestanden/633 tests, volledige ESLint, 32 gelijke NL/EN-namespaces, diff-check en Webpack-build/typecheck met 208 pagina's groen. Geauthenticeerde HR-adminbrowsercontrole bewijst `/journeys`, replacementhistorie, blokkerende preview en 390px zonder overflow, console- of serverfouten.
...
- Zichtbare appversie: `1.20260812.1` → `1.20260812.2`. Voor stap 3 resteert alleen de expliciet geplande self-/preboarding-/participant-slice; er is geen technische blocker. Geen push, merge of deployment.
