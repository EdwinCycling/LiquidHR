...
- Zichtbare versie: `1.20260829.2`; releasecommit `9d4ba572975251b3182c8f33c7c64de25aad296f` is geïntegreerd en `main == origin/main`. Vercel production deployment `dpl_4Gwo6VZyvncQdhbrbkyRyZptWkUq` is `READY` met exact dezelfde GitHub-SHA; de productie-browsercheck is groen en de route-runtime heeft geen fouten in het laatste uur. Dirty root-worktree bleef onaangeraakt. `TALENT-1` blijft geparkeerd; AI Foundation is niet gestart.
