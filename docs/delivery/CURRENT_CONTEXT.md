...
- De versie blijft `1.20260812.3`; geen push, merge of deployment.
...
- Zichtbare appversie blijft `1.20260812.3`; er is geen push, merge of deployment uitgevoerd. De remote rolegrant voor directe managers is bewust niet toegepast.
