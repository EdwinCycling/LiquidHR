...
| Documenten & compliance | [`requirements/documents/DOCUMENTEN_EN_AI_COMPLIANCE.md`](requirements/documents/DOCUMENTEN_EN_AI_COMPLIANCE.md) | LEIDEND | GEDEELTELIJK — D01 dossier/documenten deels geaccepteerd op geïsoleerde branch `work/acceptance-D01-20260924`; English browser, Settings-mobile interacties, volledige keyboard-flow en cross-tenant actor denial blijven open. Niet geïntegreerd. Globale documenten en AI-compliance volgen later. Zie [`D01 acceptance`](quality/acceptance/runs/D01-dossier-documents.md). |
