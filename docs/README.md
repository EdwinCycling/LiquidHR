...
| Surveys en eNPS | [`requirements/research/SURVEYS_AND_ENPS.md`](requirements/research/SURVEYS_AND_ENPS.md) | LEIDEND | LOKAAL TESTKLAAR — tenantmodules, schema/RLS, privacy-RPC's, 150-vragenbank, campagnebeheer, medewerkerhub, respondentflow, HR-instellingen, monitor, grafieken, CSV en rolgebonden widgets zijn gebouwd. Remote migratie/typegeneratie, authenticated browsermatrix en e-mail-/schedulerbezorging voor automatische eNPS-herinneringen blijven open |
