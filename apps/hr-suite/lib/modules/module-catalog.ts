export type ToggleableModuleCode = 'HERA' | 'DOCUMENTS' | 'REMINDERS' | 'TALENT' | 'TEAM_COMPASS'
...
const TOGGLEABLE_MODULES = new Set<ToggleableModuleCode>(['HERA', 'DOCUMENTS', 'REMINDERS', 'TALENT', 'TEAM_COMPASS'])
