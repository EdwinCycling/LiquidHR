...
import type { ProcessWorkDetailLabels } from '@/components/process-automation/process-work-detail'

export function createProcessWorkDetailLabels(t: Translator): ProcessWorkDetailLabels {
  return {
    ...
    release: t('release'),
    reassign: t('reassign'),
    reResolve: t('reResolve'),
    reassignEmployee: t('reassignEmployee'),
    reassignSubmit: t('reassignSubmit'),
    assignmentOptionsEmpty: t('assignmentOptionsEmpty'),
