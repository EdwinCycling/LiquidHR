...
const types = new Set<HrChangeEventType>(['EMPLOYMENT_STARTED','EMPLOYMENT_ENDED','INCOME_RELATIONSHIP_CHANGED','CONTRACT_CHANGED','ORGANIZATION_CHANGED','LABOR_CONDITIONS_CHANGED','SCHEDULE_CHANGED','SALARY_CHANGED','COST_ALLOCATION_CHANGED','DOCUMENT_ADDED','DOCUMENT_EXPIRES'])
