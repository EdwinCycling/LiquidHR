...
export const DASHBOARD_WIDGET_CATALOG: readonly DashboardWidgetCatalogEntry[] = [
  ...
  { type: 'COMPANY_DOCUMENTS', category: 'DOCUMENTS', titleKey: 'widgets.companyDocuments.title', descriptionKey: 'widgets.companyDocuments.description', visualization: 'TABLE', defaultWidth: 'HALF', loader: 'companyDocuments', permissions: [] },
