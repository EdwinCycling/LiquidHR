...
describe('isProtectedApplicationPath', () => {
  ...
  it.each(['/login', '/invite/accept', '/auth/callback', '/geen-toegang', '/vacancies/11111111-1111-4111-8111-111111111111/test', '/privacy', '/terms', '/icon.svg'])('laat %s publiek bereikbaar', (path) => {
