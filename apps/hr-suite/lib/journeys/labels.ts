...
export async function getJourneyLabels() {
  ...
  const keys = [
    ...
    'selectEmployment', 'noEmployment', 'manualAnchorHelp', 'employmentAnchorHelp', 'employmentRequired', 'anchorDateMismatch', 'teamHelp', 'noActivationOptions',
    'continue', 'back', 'resolveTeam', 'preview', 'activate', 'activating',
