...
export async function getJourneyLabels() {
  ...
  const keys = [
    ...
    'detailTitle', 'stepsTitle', 'stepsSubtitle', 'emptySteps', 'skipConfirmTitle', 'skipConfirmDescription', 'skipConfirm',
    'timeline', 'topicsLabel', 'pause', 'resume', 'complete', 'cancelJourney', 'replaceParticipant',
