...
describe('recruitment applicant detail migration contract', () => {
  it('maakt de bestaande application-create RPC eenduidig voor duplicate-signaling', () => {
    const migration = readFileSync(resolve(process.cwd(), 'supabase/migrations/20260825140121_20260824172115_recruitment_application_normalized_email_fix.sql'), 'utf8').toLowerCase()
