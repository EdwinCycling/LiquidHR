...
describe('guided interview participation conflict migration contract', () => {
  it('uses the existing five-column participation uniqueness contract', () => {
    const migration = readFileSync(resolve(process.cwd(), 'supabase/migrations/20260825153223_fix_recruitment_guided_interview_participation_conflict.sql'), 'utf8').toLowerCase()
