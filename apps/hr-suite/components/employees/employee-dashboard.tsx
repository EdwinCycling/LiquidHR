...
export interface EmployeeDashboardLabels extends EmployeeDashboardSummaryLabels {
  ...
  absenceOpenCase: string; workflowsOpen: string; workflowsEmpty: string; workflowsUnavailable: string; workflowsBlocked: string; workflowsOverdue: string; workflowsStart: string; absenceDiscardTitle: string; absenceDiscardDescription: string; absenceDiscardConfirm: string; absenceDiscardCancel: string
}
