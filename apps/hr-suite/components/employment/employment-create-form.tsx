...
export interface EmploymentCreateFormProps {
  ...
  labels: {
    ...
    savePrerequisites: string; prerequisiteSaved: string; bsnOptionalHelp: string; bsnHashKeyMissing: string
...
export function EmploymentCreateForm({ employeeId, options: initialOptions, locale, dateFormat, showNavigation = true, showPayrollChoice = false, onStepChange, onPayrollChoiceChange, onCancel, onSaving, onSaveFailed, onSaved, employeeSummary, copyPreviousData = false, canScrollDown = false, moreDataAvailable, labels }: EmploymentCreateFormProps) {
...
function errorMessage(code: string, labels: EmploymentCreateFormProps['labels']): string {
  ...
  if (code === 'BSN_HASH_KEY_MISSING') return labels.bsnHashKeyMissing
