...
import { ArrowDown, ArrowRight, ArrowUp, BriefcaseBusiness, CalendarDays, CircleDashed, ClipboardPlus, FileText, Gift, GripVertical, Grid2X2, HeartPulse, LayoutDashboard, LoaderCircle, Maximize2, MessageSquareText, Minimize2, PartyPopper, Sparkles, Star, Tags, UserPlus, UserRound, Users, UsersRound, Wrench } from 'lucide-react'
...
export function StartPage({ data, locale, dateFormat, timeFormat, logoUrl, greeting, labels, initialPreferences }: StartPageProps) {
  ...
  const futureItems = [labels.futureDeclarations, labels.futureContracts, labels.futureAssets, ...(data.isManager || data.isHrAdmin ? [labels.futureTasks] : [])]
