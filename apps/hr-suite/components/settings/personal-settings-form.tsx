  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <section className="rounded-2xl border bg-surface p-6 shadow-sm">
        ...
        <div className="mt-5 flex min-h-28 items-center justify-center rounded-xl border bg-sidebar p-4 text-sidebar-foreground"><Clock mode={clockMode} style={analogClockStyle} /></div>
      </section>
