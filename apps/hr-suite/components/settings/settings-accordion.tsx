...
export function SettingsAccordion({ sections, initialOpen, alwaysOpen = false }: { sections: SettingsAccordionSection[]; initialOpen?: string; alwaysOpen?: boolean }) {
