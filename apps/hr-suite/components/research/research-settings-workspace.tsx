...
interface SettingsLabels { search: string; searchPlaceholder: string; allTypes: string; allStatuses: string; sortNewest: string; sortStart: string; empty: string; invited: string; responses: string; activate: string; close: string; remind: string; working: string; actionFailed: string; actionDone: string; openMonitor: string; survey: string; enps: string; statuses: Record<ResearchCampaignSummary['status'], string> }
