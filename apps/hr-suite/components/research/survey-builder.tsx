...
interface BuilderLabels {
  campaign: string; title: string; description: string; startsAt: string; endsAt: string; anonymous: string; target: string; targetMode: string; targetAll: string; targetDepartments: string; targetLocations: string; targetEntities: string; targetEmployees: string; targetSearch: string; targetEmpty: string; selected: (count: number) => string; questions: string; addQuestion: string; question: (number: number) => string; questionText: string; questionType: string; required: string; remove: string; moveUp: string; moveDown: string; options: string; optionPlaceholder: string; matrixRows: string; matrixPlaceholder: string; typeTextSingle: string; typeTextMulti: string; typeSingleChoice: string; typeMultiChoice: string; typeNumber: string; typeDate: string; typeDatetime: string; typeMatrix: string; saveDraft: string; saving: string; saveFailed: string
}
