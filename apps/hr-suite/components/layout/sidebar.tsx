...
export function Sidebar({
  ...
  useEffect(() => {
    const load = () => {
      try {
        ...
        const allowedMenuHrefs = new Set(['/dashboard', '/dashboard/start', '/employees', '/work', '/organization-chart', '/hr-calendar', '/insights', '/workforce', '/team-compass', '/settings'])
  ...
  }, [canReadProcessWork, canReadStartPage, canReadTeamCompass, canReadWorkforce])
