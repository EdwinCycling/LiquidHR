...
const baseReport: AiUsageReport = {
  ...
  requests: 2,
  successRate: 100,
  trend: [{ date: '2026-08-01', capabilityCredits: 2, voiceCredits: 1, creditsUsed: 3, requests: 2 }],
  ...
  voice: { sessions: 1, totalDurationSeconds: 60, averageDurationSeconds: 60, voiceCredits: 1, successful: 1, failed: 0, cancelled: 0, byContext: { employee: 0, team: 1, other: 0 } },
}
...
describe('AI usage report view', () => {
  it('renders safe KPIs, breakdowns and trend without source metadata', () => {
    ...
    expect(markup).toContain('Voice usage')
    expect(markup).toContain('Combined credits')
  ...
  it('renders an explicit empty state for a period without usage', () => {
    const emptyReport = { ...baseReport, capabilityCredits: 0, voiceCredits: 0, combinedCredits: 0, creditsUsed: 0, requests: 0, successRate: null, byFeature: [], byQuality: [], byStatus: [], trend: [{ date: '2026-08-01', capabilityCredits: 0, voiceCredits: 0, creditsUsed: 0, requests: 0 }], voice: { sessions: 0, totalDurationSeconds: 0, averageDurationSeconds: null, voiceCredits: 0, successful: 0, failed: 0, cancelled: 0, byContext: { employee: 0, team: 0, other: 0 } } }
