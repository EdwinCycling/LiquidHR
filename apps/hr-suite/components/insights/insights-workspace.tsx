...
export function InsightsWorkspace({ labels, reports, reportData, upcomingReport, upcomingQuery, preferences, locale, dateFormat }: { labels: InsightsLabels; reports: readonly InsightReportDefinition[]; reportData: EmployeeInsightReport | null; upcomingReport: UpcomingEventsReport | null; upcomingQuery: UpcomingEventsQuery; preferences: InsightsPreferences; locale: string; dateFormat: DateFormat }) {
