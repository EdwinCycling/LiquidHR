...
import { claimWorkItem, workItemErrorResponse } from '@/lib/process-automation/work-item-service'
...
export async function POST(request: Request, { params }: Params): Promise<NextResponse> {
  try {
    ...
    return NextResponse.json({ data: await claimWorkItem(workItemId, parsed.data.expectedVersion) })
  } catch (error) {
