...
import { releaseWorkItem, workItemErrorResponse } from '@/lib/process-automation/work-item-service'
...
export async function POST(request: Request, { params }: Params): Promise<NextResponse> {
  try {
    ...
    return NextResponse.json({ data: await releaseWorkItem(workItemId, parsed.data.expectedVersion) })
  } catch (error) {
