...
export default async function StartPageRoute({ searchParams }: StartPageRouteProps) {
  ...
  return <StartPage data={data} locale={locale} dateFormat={preferences.dateFormat} timeFormat={preferences.timeFormat} greeting={greeting} initialPreferences={startPagePreferences} labels={{
