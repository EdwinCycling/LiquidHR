...
export default async function ProductUpdatesRoute() {
  ...
  const labels: ProductUpdateSurfaceLabels = {
    title: t('title'), subtitle: t('subtitle'), open: t('open'), close: t('close'), kindNewFeature: t('kindNewFeature'), kindImprovement: t('kindImprovement'), giftWindow: t('giftWindow'), loginPopup: t('loginPopup'), topBanner: t('topBanner'), dateFrom: t('dateFrom'), dateUntil: t('dateUntil'), more: t('more'), manage: t('manage'), seen: t('seen'), empty: t('empty'), unreadCount: t('unreadCount'),
  }
