...
export default async function EmployeeDetailPage({ params, searchParams }: EmployeeDetailPageProps) {
  ...
  const canReportAbsence = canWriteAbsenceForEmployee && (authContext.employeeId !== employeeId || selfReport)
