        ...
        <EmployeePersonCard
          ...
          labels={{
            ...
            relationOther: tEmployees('relationOther'), emergencyContact: tEmployees('emergencyContact'), lastName: tEmployees('lastName'),
             ...
             employeeTitle: tEmployees('employeeTitle'), employeeInitials: tEmployees('employeeInitials'), pronouns: tEmployees('pronouns'), partnerNamePrefix: tEmployees('partnerNamePrefix'), partnerName: tEmployees('partnerName'), maritalStatus: tEmployees('maritalStatus'), maritalStatusSingle: tEmployees('maritalStatusSingle'), maritalStatusMarried: tEmployees('maritalStatusMarried'), maritalStatusRegisteredPartnership: tEmployees('maritalStatusRegisteredPartnership'), maritalStatusDivorced: tEmployees('maritalStatusDivorced'), maritalStatusWidowed: tEmployees('maritalStatusWidowed'), maritalStatusDate: tEmployees('maritalStatusDate'), educationLevel: tEmployees('educationLevel'), educationMbo: tEmployees('educationMbo'), educationHbo: tEmployees('educationHbo'), educationWo: tEmployees('educationWo'), educationHighschool: tEmployees('educationHighschool'), educationOther: tEmployees('educationOther'), educationUnknown: tEmployees('educationUnknown'),
          }}
        />
