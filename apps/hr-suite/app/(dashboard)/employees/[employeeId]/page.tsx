...
import { EmployeeAiActions } from '@/components/employees/employee-ai-actions'
...
export default async function EmployeeDetailPage({ params, searchParams }: EmployeeDetailPageProps) {
  ...
  return (
      <PageShell width="standard" className="py-7 lg:py-10">
        ...
        {tab === 'overview' && canUseAi && isAiImproveAvailable() ? <EmployeeAiActions employeeId={employeeId} locale={locale} labels={{
