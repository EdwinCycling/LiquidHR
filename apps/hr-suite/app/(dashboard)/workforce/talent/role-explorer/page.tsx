...
export default async function WorkforceTalentRoleExplorerPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
