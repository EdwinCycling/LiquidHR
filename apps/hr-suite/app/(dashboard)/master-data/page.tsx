...
export default async function MasterDataPage({ searchParams }: Props) {
  ...
  const labels = { code: t('catalog.code'), name: t('catalog.name'), nameNl: t('catalog.nameNl'), nameEn: t('catalog.nameEn'), description: t('catalog.description'), add: t('catalog.add'), saving: t('catalog.saving'), activate: t('catalog.activate'), deactivate: t('catalog.deactivate') }
