...
export default async function MasterDataPage({ searchParams }: Props) {
  ...
  const labels = { code: t('catalog.code'), name: t('catalog.name'), nameNl: t('catalog.nameNl'), nameEn: t('catalog.nameEn'), description: t('catalog.description'), add: t('catalog.add'), save: t('save'), saving: t('catalog.saving'), activate: t('catalog.activate'), deactivate: t('catalog.deactivate'), delete: t('delete'), deleteConfirm: t('deleteConfirm'), deleteFailed: t('deleteFailed'), inUse: t('inUse'), failed: t('failed'), empty: t('empty'), cancel: t('cancel'), close: t('close'), toggle: t('toggle'), edit: t('edit'), salarySensitive: t('salarySensitive'), duplicate: t('duplicate'), invalid: t('invalid'), discardTitle: t('catalog.discardTitle'), discardDescription: t('catalog.discardDescription'), discardConfirm: t('catalog.discardConfirm'), discardCancel: t('catalog.discardCancel'), toggleConfirm: t('catalog.toggleConfirm') }
