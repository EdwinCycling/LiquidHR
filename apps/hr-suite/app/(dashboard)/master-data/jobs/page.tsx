...
export default async function JobsPage() {
  ...
  return <section className="mx-auto w-full max-w-7xl px-5 py-8 sm:px-8 sm:py-10 lg:px-10">
    ...
    <JobCatalogManager groups={catalog.groups} jobs={catalog.jobs} families={catalog.families} seniorities={catalog.seniorities} labels={{
      ...
      deactivate: t('deactivate'), groupSelection: t('groupSelection'), groupRequired: t('groupRequired'), search: t('search'), sortBy: t('sortBy'), sortCode: t('sortCode'), sortName: t('sortName'), sortStatus: t('sortStatus'), allGroups: t('allGroups'), addNew: t('addNew'), cancel: t('cancel'), close: t('close'), create: t('create'), editGroup: t('editGroup'), editJob: t('editJob'), confirmDeleteTitle: t('confirmDeleteTitle'), confirmDeleteBody: t('confirmDeleteBody'), confirmDelete: t('confirmDelete'), noResults: t('noResults'), listDescription: t('listDescription'), filters: t('filters'), graphTitle: t('graphTitle'), graphSubtitle: t('graphSubtitle'), jobsInGroup: t('jobsInGroup'), noJobsInGroup: t('noJobsInGroup'), family: t('family'), allFamilies: t('allFamilies'), noFamily: t('noFamily'), seniority: t('seniority'), noSeniority: t('noSeniority'), familyContext: t('familyContext'),
    }} />
  </section>
}
