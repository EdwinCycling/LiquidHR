...
import { getSalaryExceptionReport } from '@/lib/insights/salary-exceptions'
...
export default async function InsightsPage({ searchParams }: InsightsPageProps) {
  ...
  const salaryExceptionsReport = params.get('report') === 'salary-exceptions' && reports.some((report) => report.id === 'salary-exceptions') ? await getSalaryExceptionReport() : null
  ...
  }} dateFormat={userPreferences.dateFormat} locale={locale} reportData={salaryExceptionsReport ?? reportData} reports={reports} preferences={preferences} />
}
