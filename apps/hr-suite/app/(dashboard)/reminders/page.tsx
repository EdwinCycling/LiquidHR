...
export default async function RemindersPage() {
  const [t, reminders, locale] = await Promise.all([getTranslator('reminders'), listMyReminders(), getLocale()])
