...
export default async function AdminSettingsPage() {
  ...
  const sections = [
    { title: messages('admin.sections.organization'), items: [
      ...
      { modal: 'employees' as const, icon: Users, title: messages('admin.tiles.employees'), description: messages('admin.tiles.employeesDescription'), visible: true },
