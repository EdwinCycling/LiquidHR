...
function typeLabels(t: Awaited<ReturnType<typeof getTranslator>>) {
  return {
    ...
    tabs: { base: t('type.baseTab'), limits: t('type.limitsTab'), advanced: t('type.advancedTab') }, name: t('type.name'), nameRequired: t('type.nameRequired'), nameExists: t('type.nameExists'), color: t('type.color'),
