...
import { listEmployeeAbsenceEmploymentOptions } from '@/lib/absence/service'
...
export default async function NewAbsencePage({ searchParams }: NewAbsencePageProps) {
  ...
  const employmentSelection = selectedEmployee ? await listEmployeeAbsenceEmploymentOptions(selectedEmployee.id) : null
