...
using (
  ...
  or (
    ...
    and exists (
      ...
      join public.job_profile_versions profile_version on profile_version.tenant_id = requirement.tenant_id and profile_version.id = requirement.profile_version_id
      join public.job_profiles profile on profile.tenant_id = profile_version.tenant_id and profile.id = profile_version.job_profile_id
      join public.employee_organizations organization on organization.tenant_id = profile.tenant_id and organization.job_id = profile.job_id
