...
values
  ...
  ('Werkdruk, Stress & Werk-priv�balans', 2),
...
values
  ...
  ('Werkdruk, Stress & Werk-priv�balans', 2, 11, 'De werkdruk die ik ervaar is over het algemeen acceptabel.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 12, 'Ik kan mijn werk goed combineren met mijn priv�leven.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 13, 'Ik kan na mijn werkdag stoom afblazen en de knop omzetten.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 14, 'Ik heb voldoende tijd om mijn taken met de juiste kwaliteit uit te voeren.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 15, 'Ik voel me niet structureel gehaast tijdens mijn werkzaamheden.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 16, 'De organisatie stimuleert en ondersteunt een geslaagde werk-priv�balans.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 17, 'Ik voel voldoende ruimte om pauzes te nemen wanneer ik daar behoefte aan heb.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 18, 'Ik ervaar geen ongezonde mate van stress door mijn werk.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 19, 'In drukke periodes staat mijn team klaar om werk van elkaar over te nemen.', 'LIKERT_5', false),
  ('Werkdruk, Stress & Werk-priv�balans', 2, 20, 'Mijn leidinggevende heeft oog voor mijn mentale en fysieke welzijn.', 'LIKERT_5', false),
  ...
  ('Leiderschap & Management', 3, 29, 'Mijn leidinggevende staat open voor idee�n en kritische feedback.', 'LIKERT_5', false),
  ...
  ('Persoonlijke Groei & Ontwikkeling', 5, 48, 'We bespreken mijn persoonlijke ontwikkeling minimaal ��n keer per jaar.', 'LIKERT_5', false),
  ...
  ('Autonomie, Functie & Rolhelderheid', 7, 67, 'Ik kan effici�nt werken zonder continu onderbroken te worden.', 'LIKERT_5', false),
  ...
  ('Interne Communicatie & Visie', 8, 77, 'Mijn mening en idee�n worden serieus genomen als ik deze inbreng.', 'LIKERT_5', false),
  ...
  ('Faciliteiten, Werkplek & Hybride Werken', 10, 96, 'De kleding-, veiligheids- of hygi�nevoorschriften zijn helder en worden nageleefd.', 'LIKERT_5', false),
  ...
  ('Innovatie, Verandering & Wendbaarheid', 12, 112, 'Idee�n voor verbetering vanuit medewerkers worden snel en serieus opgepakt.', 'LIKERT_5', false),
  ...
  ('Innovatie, Verandering & Wendbaarheid', 12, 114, 'Binnen ons bedrijf wordt ge�xperimenteerd met nieuwe methoden, technieken of middelen.', 'LIKERT_5', false),
  ('Innovatie, Verandering & Wendbaarheid', 12, 115, 'Mijn leidinggevende moedigt mij aan om met slimmere en effici�ntere oplossingen te komen.', 'LIKERT_5', false),
  ...
  ('Innovatie, Verandering & Wendbaarheid', 12, 120, 'Ik word voldoende betrokken bij veranderingen die mijn dagelijkse werk be�nvloeden.', 'LIKERT_5', false),
  ...
  ('Vitaliteit, Gezondheid & Energiemanagement', 15, 145, 'Ik ervaar aan het einde van mijn werkweek nog genoeg energie voor mijn priv�leven.', 'LIKERT_5', false),
