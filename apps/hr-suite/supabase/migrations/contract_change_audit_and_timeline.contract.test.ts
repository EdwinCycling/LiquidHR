...
const auditTimelineSql = readFileSync('supabase/migrations/20260912072902_20260912072624_contract_change_audit_and_timeline.sql', 'utf8').replace(/\r\n/g, '\n')
const statusSql = readFileSync('supabase/migrations/20260912074511_20260912074130_repair_contract_terminal_selection_status.sql', 'utf8').replace(/\r\n/g, '\n')
