...
-- P5: geautoriseerde scope-actors zonder employee-id mogen alleen de twee form-RPC's gebruiken.
-- Candidate- en employee-autorisatie blijven via de bestaande hardened helper lopen.
...
begin
  ...
  if not (
    (
      ...
      and coalesce(internal_security.process_scope_has_permission(
        instance_row.tenant_id,
        instance_row.hr_group_id,
        instance_row.scope_type,
    ...
    or (
      ...
      and coalesce(internal_security.process_form_actor_allowed(
