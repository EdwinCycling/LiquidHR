...
insert into public.team_compass_questions (
  ...
  (md5('team-compass:v1:q07')::uuid, md5('team-compass:collaboration:v1')::uuid, 'Q07', 'ACTION', 'Ik neem graag verantwoorde risico�w^~)�v��y��y�s om vooruitgang te boeken.', 'I like taking considered risks to make progress.', 7),
  ...
  (md5('team-compass:v1:q25')::uuid, md5('team-compass:collaboration:v1')::uuid, 'Q25', 'HARMONY', 'Ik neem de tijd om collega�w^~)�v��y��y�s goed te ondersteunen.', 'I take time to support colleagues well.', 25),
