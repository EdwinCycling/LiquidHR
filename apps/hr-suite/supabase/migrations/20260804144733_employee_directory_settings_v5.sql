...
begin
  ...
  result := jsonb_build_object(
    ...
    'schedule', case when settings_row.employee_directory_show_schedule then coalesce((
            ...
            'status', case
              ...
              when pattern_row.id is not null and exists (
                ...
                where pattern_day.tenant_id = requested_tenant_id and pattern_day.administration_id = requested_administration_id
                  ...
                  and pattern_day.week_index = ((floor((day_date - pattern_row.anchor_date)::numeric / 7)::integer % pattern_row.cycle_weeks) + 1)
