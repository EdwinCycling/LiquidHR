...
select 'cost:'||allocation.id, allocation.tenant_id, allocation.administration_id, allocation.employee_id, allocation.employment_id, allocation.valid_from,
  'COST_ALLOCATION_CHANGED', 'employment.event.costAllocation', jsonb_build_object('percentage',allocation.percentage,'costCenter',center.name,'validUntil',allocation.valid_until),
