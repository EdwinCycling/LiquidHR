...
-- P6 keeps the work queue server-authorized and returns a deliberately small
-- projection.  The runtime tables remain read-only through the data API; all
-- filtering below is repeated inside the security-definer projection.
