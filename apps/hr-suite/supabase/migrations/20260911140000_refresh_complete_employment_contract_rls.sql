-- DEV repair: refresh the narrow employment-contract insert guard after the
-- complete-employment RPC started propagating hr_group_id explicitly.
-- Keep SECURITY INVOKER on the publication RPC and preserve both RLS gates.
