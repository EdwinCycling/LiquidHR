-- Stap 6: complete employment publiceert groepssleutels op iedere
-- groepsgebonden entiteit. Payrollvelden blijven aan de gekozen administratie.
...
begin
  ...
  insert into public.employment_contracts (
    ...
    requested_tenant_id, requested_hr_group_id, requested_administration_id, requested_employee_id,
    created_employment_id, 1, (contract_payload ->> 'workerType')::public.employment_worker_type,
  ...
  insert into public.employment_change_sets (
    ...
    case when salary_payload is null then array[
