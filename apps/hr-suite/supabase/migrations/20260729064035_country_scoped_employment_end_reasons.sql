...
cross join (
  values
    ...
    ('04', 'Be�indiging arbeidsovereenkomst met wederzijds goedvinden op initiatief van de werkgever', 'Termination by mutual consent at the employer''s initiative'),
    ...
    ('90', 'De arbeidsovereenkomst loopt door, maar de inkomstenverhouding is administratief be�indigd', 'Employment continues, but the income relationship is administratively ended'),
